...
/**
 * Static security headers. `Content-Security-Policy` is NOT set here
 * because it carries a per-request nonce — see
 * `src/lib/supabase/middleware.ts` + `src/lib/security/csp.ts`.
 */
